...
/** Condensed Pick n Pay briefing — full deck remains at #pick-n-pay-partnership-deck */
const TOTAL = 11;
  ...
  switch (index) {
              ...
              <DeckTitleLayout>
                <div>
                  <DeckEyebrow light theme={theme}>
                    Pick n Pay SOUTH AFRICA · CONDENSED BRIEFING · CONFIDENTIAL
                  </DeckEyebrow>
                  <CoBrandRow light />
                ...
                <div className="text-white/45 space-y-0.5 text-[10px] sm:text-xs">
                  ...
                  <p>bigfivegroup.africa/partner/pick-n-pay#pick-n-pay-partnership-deck-condensed</p>
                </div>
              </DeckTitleLayout>
            </div>
          </div>
    ...
    case 1:
      return (
        <DeckSlideShell theme={theme}>
          ...
          <DeckTitle>Pick n Pay does good — in {TOTAL} slides</DeckTitle>
          <ol className={forPrint ? "space-y-1.5 max-w-2xl" : "space-y-2.5 max-w-2xl"}>
            {[
              "Why Pick n Pay leads · Mandela pack products",
              "Pricing & Pick n Pay front margin (R45 / R67)",
              "Sell · donate · 10% to foundations",
              "National impact snapshot · NPOs · SA Harvest",
              "What Pick n Pay wins · governance · the ask",
            ].map((item, i) => (
          ...
          <p className="mt-4 text-[11px] text-[#737373]">
            ...
            <a href="#pick-n-pay-partnership-deck" className="font-semibold underline underline-offset-2 text-black">
              full Pick n Pay partnership deck
            </a>{" "}
        ...
        <DeckSlideShell dark theme={theme}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 mt-1">
            {[
              ...
              >
                <p.icon className={`mb-2 text-red-300 ${forPrint ? "w-4 h-4" : "w-5 h-5"}`} />
    ...
    case 3:
      return (
        <DeckSlideShell theme={theme}>
          ...
          <div
            className={`mt-3 rounded-xl border border-red-200 bg-red-50/70 ${
            ...
            {[M.kg1, M.g400].map((tier) => (
              ...
              >
                ...
                <div className="grid grid-cols-3 gap-0 border-t border-black/5">
                  ...
                  <div className="p-3 border-l border-emerald-100 bg-red-50/80">
                    <div className="text-[9px] font-semibold uppercase" style={{ color: theme.accentDark }}>
                      Margin
                    </div>
                    <div
      ...
      return (
        <DeckSlideShell theme={theme}>
          <div className="flex h-full min-h-0 flex-col">
            ...
            <div
              className={`rounded-2xl border-2 border-red-200 bg-red-50/60 shrink-0 ${
            ...
            >
              <div
                ...
                style={{ color: theme.accentDark }}
              >
                10% model · Pick n Pay 5% + Big Five Foods 5%
              </div>
              <p
              ...
              >
                {dense
                  ? "Pick n Pay and Big Five Foods ring-fence 10% of partnership product turnover (Pick n Pay 5% + Foods 5%) so every sale supports Restore Africa Foundation and A Heart To Help — Pick n Pay as the face of good in the community."
                  : P.giving.detail}
              </p>
              <div
              ...
              >
                <p className="leading-snug">{P.giving.bases.picknPay}</p>
        ...
        <DeckSlideShell theme={theme}>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 mb-3">
            <DeckStatTile
              ...
              label="Stores modelled (~709 Pick n Pay grocery)"
            />
            <DeckStatTile
              theme={theme}
              value={formatZarCompact(IMPACT.national.picknPayFrontMargin)}
              label="Pick n Pay front margin pool / year"
            />
            <DeckStatTile
              theme={theme}
          ...
          <p className="mt-2 text-[11px] text-[#404040]">
            ...
            {formatZarCompact(IMPACT.pilot.picknPayFrontMargin)} front margin · full tables in the{" "}
            <a href="#pick-n-pay-partnership-deck" className="font-semibold underline underline-offset-2">
              full deck
            </a>
            .
          </p>
    ...
    case 7: {
      ...
      const npoPrintSummary: Record<string, string> = {
        ...
        "sa-harvest":
          "Last-mile delivery of donated product to soup kitchens, feeding schemes, Restore Africa Foundation and A Heart To Help — so Pick n Pay donations reach plates.",
      };
      return (
        <DeckSlideShell theme={theme}>
          <div className="flex h-full min-h-0 flex-col">
            <div className="shrink-0">
              <DeckEyebrow theme={theme}>WHO Pick n Pay STANDS WITH</DeckEyebrow>
              ...
              {P.npos.map((n) => (
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    <div
                      className={`font-bold tracking-wide uppercase text-red-800 ${
            ...
            >
              <strong className="text-black">Chain:</strong> Pick n Pay sells or donates · Big Five Foods
            ...
            {[
              {
                icon: Scale,
                t: "Term sheet first",
                d: "SKUs, R45 / R67, margin discipline, 5%+5% giving, NPO split, Pick n Pay brand story.",
              },
              {
                icon: Building2,
                t: "Transparent reporting",
                d: "Quarterly units sold, packs donated, rand to each foundation, stories Pick n Pay can share.",
              },
            ].map((it) => (
              <div
                key={it.t}
                className="rounded-xl border border-emerald-100 bg-red-50/50 p-3 flex gap-2 min-w-0"
              >
                ...
                <div className="space-y-3">
                  <a
                    href={`mailto:${P.contactEmail}?subject=${encodeURIComponent(
                      "Pick n Pay × Big Five Foods — condensed partnership brief"
                    )}`}
                  ...
                  <div className="text-white/45 text-xs">
                    Full deck: /partner/pick-n-pay#pick-n-pay-partnership-deck · Condensed: #pick-n-pay-partnership-deck-condensed
                  </div>
                </div>
              </DeckTitleLayout>
            </div>
...
export default function PicknPayPartnershipDeckCondensed() {
  return (
    <div id="pick-n-pay-partnership-deck-condensed" className="scroll-mt-28 w-full min-w-0">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mb-6 sm:mb-8 text-center">
        ...
        <div
          ...
          style={{ color: "#006633" }}
        >
          Pick n Pay CONDENSED BRIEFING · {TOTAL} SLIDES · PRIVATE · Pick n Pay ONLY
        </div>
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold tracking-tighter text-black mb-2 text-balance">
          Pick n Pay does good — condensed deck
        </h2>
        <p className="text-sm sm:text-base text-[#525252] max-w-2xl mx-auto leading-relaxed">
          Shorter briefing for Pick n Pay: margin, Mandela pack, 10% foundations, impact snapshot and the
          ask. The{" "}
          <a href="#pick-n-pay-partnership-deck" className="font-semibold text-black underline underline-offset-2">
            full 20-slide deck
          </a>{" "}
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <DeckShell
          id="pick-n-pay-partnership-deck-condensed-shell"
          printRootId="pick-n-pay-partnership-deck-condensed-print-root"
          total={TOTAL}
          theme={theme}
          eyebrow="Pick n Pay CONDENSED DECK"
          title="Pick n Pay does good — Condensed Partnership Briefing"
          description="Condensed Pick n Pay briefing: R45/R67 margin, Mandela pack, 10% foundations, impact snapshot."
          sharePath="/partner/pick-n-pay#pick-n-pay-partnership-deck-condensed"
          shareTitle="Pick n Pay does good — condensed briefing"
          shareText="Condensed Pick n Pay partnership brief: Mandela pack, store margin, 10% to foundations."
          renderSlide={(i) => <Slide index={i} />}
        />
      </div>
      <p className="mt-4 text-center text-xs text-[#737373] px-4 max-w-2xl mx-auto">
        Keyboard: ← → ·{" "}
        <span className="font-medium text-black">/partner/pick-n-pay#pick-n-pay-partnership-deck-condensed</span>
        {" · "}
        Full deck:{" "}
        <a href="#pick-n-pay-partnership-deck" className="font-medium text-black underline underline-offset-2">
          #pick-n-pay-partnership-deck
        </a>
      </p>
    </div>
  );
