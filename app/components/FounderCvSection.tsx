...
import { FOUNDER_CV, FOUNDER_CV_PDF } from "../lib/founderCv";
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-8 sm:mb-10 print:mb-6">
          <div className="min-w-0">
            ...
            <p className="text-sm sm:text-base text-[#525252] mt-2 max-w-2xl leading-relaxed text-pretty">
              Full professional profile for investor diligence. Download a branded A4 portrait PDF,
              or open LinkedIn and ResearchGate from the links below.
            </p>
          </div>
          <a
            href={FOUNDER_CV_PDF.href}
            download={FOUNDER_CV_PDF.filename}
            className="shrink-0 inline-flex items-center gap-2 rounded-full bg-[#0a0a0a] text-white px-5 py-2.5 text-sm font-semibold hover:bg-amber-700 transition-colors print:hidden shadow-sm"
          >
            <Download className="w-4 h-4 text-amber-300" />
            {FOUNDER_CV_PDF.label}
          </a>
        </div>
        ...
        {/* Download band */}
        <div className="mt-8 sm:mt-10 rounded-2xl border border-amber-200/80 bg-gradient-to-br from-amber-50 to-white p-5 sm:p-7 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 print:hidden">
          <div className="min-w-0">
            <div className="text-[10px] tracking-[2px] text-amber-800 font-semibold mb-1">
              A4 PORTRAIT · BRANDED PDF
            </div>
            <p className="text-sm text-[#404040] leading-relaxed max-w-xl">
              Print-ready curriculum vitae for diligence packs — three pages, Big Five branding,
              photo and full career detail.
            </p>
          </div>
          <a
            href={FOUNDER_CV_PDF.href}
            download={FOUNDER_CV_PDF.filename}
            className="shrink-0 inline-flex items-center justify-center gap-2 rounded-full bg-[#0a0a0a] text-white px-5 py-2.5 text-sm font-semibold hover:bg-amber-700 transition-colors"
          >
            <Download className="w-4 h-4 text-amber-300" />
            {FOUNDER_CV_PDF.label}
          </a>
