  ...
  return (
    <div className="overflow-hidden bg-[#fafafa]">
      ...
      <section className="relative min-h-[100dvh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl px-6 text-center mt-[-20px]">
          ...
          <p className="max-w-2xl mx-auto text-2xl text-white font-light tracking-tight mb-12">
            With deepest honour to His Majesty the late King Goodwill Zwelithini kaBhekuzulu<br />
            and in full support of the Goodwill Foundation,<br />
            Big Five Group stands with the Zulu Kingdom — honouring the Nguni tribe and their timeless ethics, respecting the 720 Tribal Authorities, amplifying its voice, and advancing its future.
          </p>
