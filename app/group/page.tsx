...
> = {
  ...
  impact: {
    mission: "Cross-cutting",
    serves:
      "Orchestrates multi-pillar programmes so strategy becomes delivery — on time and on impact. Supports the Director General of Health with initiatives to accelerate and promote health and wellness in South Africa, Africa and beyond.",
    system:
