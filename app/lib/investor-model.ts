...
export const MARKET_TRACTION = {
  ...
  healthChannel: {
    title: "We aspire to work with the Director General of Health in South Africa",
    detail:
      "Big Five aspires to work with the Director General of Health in South Africa — not as staff of Big Five Impact, but as a strategic institutional relationship we seek — to help drive Group products into South Africa’s Department of Health as programmes mature. Impact would coordinate delivery and programme discipline around that channel.",
  },
  asOfNote:
