...
export const PARTNERS: PartnerProfile[] = [
  ...
  },
  {
    ...
    notes: [
      ...
      "Giving (same principle as SPAR / Pick n Pay decks): CMH Ford 5% + Big Five Foods 5% of pack turnover at R45 → Restore Africa Foundation and A Heart To Help (GBV organisation).",
