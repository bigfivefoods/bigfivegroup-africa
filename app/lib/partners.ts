...
export const PARTNERS: PartnerProfile[] = [
  ...
  },
  {
    ...
    headline: "SPAR × Big Five Foods",
    summary:
      "Partnership workspace for SPAR South Africa and Big Five Foods — list fortified African staples (Nelson Mandela pack: R45 trade ex. VAT · R67 RRP incl. VAT), sell to customers and/or donate to Restore Africa Foundation and A Heart To Help, with 10% of partnership turnover (SPAR 5% + Big Five Foods 5%) supporting those NPO feeding initiatives.",
    focus: ["Foods", "Foundation", "Impact", "Feed", "Retail"],
    ...
    notes: [
      "Open the SPAR partnership pitch deck below (#spar-partnership-deck) — full commercial model for listing, Mandela pack pricing and NPO giving.",
      "Trade R45 (ex. VAT) · RRP R67 (incl. VAT) for the Nelson Mandela campaign pack — confirm SKUs on term sheet.",
      "10% model: SPAR 5% of retail sell-through + Big Five Foods 5% of trade turnover → Restore Africa Foundation and A Heart To Help.",
      "Dual pathways: shelf sales to SPAR customers and/or donation purchase orders into the two foundations.",
      "Add authorised SPAR emails to this profile when portal logins are ready.",
    ],
    resources: [
      {
        href: "#spar-partnership-deck",
        label: "SPAR partnership pitch deck",
        desc: "17-slide pitch: pricing, 10% model, NPOs, roadmap and the ask.",
      },
      {
        href: "/foods",
        label: "Big Five Foods",
  ...
  },
  {
    ...
    notes: [
      "Restore Africa Foundation is a registered Non-Profit Company (Ballito / KZN) — children first, community rebuild, school programmes such as Veggies4Kids.",
