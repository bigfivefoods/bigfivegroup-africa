...
export const PARTNERS: PartnerProfile[] = [
  ...
  },
  {
    ...
    emails: [],
    role: "Royal house · Isidlo seSilo · Big Five Royal Foods",
    headline: "Serving the Royal House · Isidlo seSilo",
    summary:
      "Private workspace for the proposed establishment of Big Five Royal Foods (Pty) Ltd as Official Meal Partner of the Royal Household, and for Isidlo seSilo — the Official Nutrition Programme of the Kingdom — under Heads of Agreement principal terms (BF/RH/HOA/FINAL-V5) prepared for signature at the 2nd Annual Amazulu Queens' High Tea (23 Sep 2026, Zimbali Lakes Resort). Also covers the 50:50 Feed · Educate · Empower value chain (Agri → Foods → Royal → Direct).",
    focus: [
      "Isidlo seSilo",
      "Big Five Royal Foods",
      "Ingonyama Trust",
      "Reed Dance",
      "Amabutho",
      "Queens' High Tea",
    ...
    notes: [
      ...
      "Board as tabled: Dr. Craig Ross Muller — Executive Director / CEO; Prince Ntokozo — NED / Royal Liaison; Dr. Joy (Natalie) — Business Development Executive, Royal Household Wellness, Strategy & Stakeholder Relations; Independent Chair — mutual agreement.",
      ...
      "This portal does not speak for the Palace. Heritage language remains anchored to zulukingdom.co.za. Add authorised Household / Prince Ntokozo / Queens’ office emails when portal logins are ready. Do not list Dr. Joy, Prince Ntokozo, or the Queens as portal admins.",
      "50:50 Group framing and Agri→Foods→Royal→Direct remain proposed Group narrative alongside HOA principal operating terms — HOA ≠ executed SHA/MOI.",
    ],
    resources: [
      {
        href: "#isidlo-sesilo",
        label: "Isidlo seSilo",
        desc: "Official Nutrition Programme of the Kingdom — HOA principal terms.",
      },
      {
        href: "#royal-foods-entity",
        label: "Big Five Royal Foods (Pty) Ltd",
        desc: "New operating company · Official Meal Partner (proposed).",
      },
      {
        href: "#governance",
        label: "Governance & board",
        desc: "CEO, Prince Ntokozo, patrons, TBC seats.",
      },
      {
        href: "#activations",
        label: "Royal activations",
        desc: "Reed Dance, Amabutho, calendar, schools, relief.",
      },
      {
      ...
      },
      {
        ...
        label: "Strategic partnership deck",
        desc: "25-slide briefing — 50:50, value chain, Isidlo seSilo HOA, leopard branding.",
      },
      {
        href: "#value-chain",
    ...
    contactNote:
      "Primary Group contact: craig@bigfivegroup.africa (Dr. Craig R. Muller) · Private Office: zulukingdom.co.za · Add authorised Household emails when logins are ready",
  },
  {
