/**
 * Checkers × Big Five Foods partnership model — Checkers-facing narrative.
 * Emphasise Checkers margin + Checkers doing good. Never expose Big Five Foods GP.
...
const CHECKERS_MARGIN_RAND = MARGIN_RAND_1KG;
const CHECKERS_MARGIN_PCT = MARGIN_PCT_1KG;
...
export const CHECKERS_PARTNERSHIP = {
  ...
  product: {
    ...
    tradePriceNote: "1kg Mandela pack · Checkers cost · exclusive of VAT",
    ...
    vatRate: VAT_RATE,
    vatNote:
      "Two listing tiers: 1kg Mandela pack (porridges & one-pots) at R45 ex. VAT / R67 incl. VAT; 400g (soya & soups) at R18 ex. VAT / R33.50 incl. VAT. Checkers front margin aligns each trade cost to 15% VAT for a fair shelf comparison.",
    campaignLine:
      "Nelson Mandela range — four fortified African categories, two clear pack prices, Checkers margin on every SKU, and 10% ring-fenced for foundations.",
    pricingTiers: {
    ...
    /**
     * 1kg one-pot yield — specific claim for Checkers shelf talk and impact maths.
    ...
    onePotYield: {
      ...
      detail:
        "The flagship 1kg Big Five Foods one-pot pack makes 4kg of food when prepared — that is 20 × 200g servings. At the Mandela pack RRP of R67 incl. VAT, each 200g meal costs R3.35 (R67 ÷ 20). Clear shelf talk for Checkers: complete fortified plate, not just dry weight.",
    },
  },

  /**
   * Mandela pack range — all four Big Five Foods categories for Checkers shelf / donation.
  ...
  mandelaPackRanges: [
    ...
    },
    {
      ...
      blurb:
        "Plant-based protein mince in culturally familiar formats for stews, pap and institutional menus. Gives Checkers shoppers a protein upgrade when meat prices spike — and gives foundations a stable protein line without cold-chain meat logistics.",
      nutrition:
    ...
    },
    {
      ...
      retailAngle:
        "Entry price point for first trial purchase. High acceptance gift/donation line. Easy multipack for Checkers loyalty and Mandela campaign baskets.",
      serve: "Households · clinics · ECD · emergency & community kitchens",
    },
  ] as const,

  /**
   * Checkers store / retailer economics — what Checkers makes (not Big Five GP).
  ...
  checkersMargin: {
    ...
    headline: "Healthy front margin for Checkers on every pack sold at RRP",
    detail:
    ...
    honesty:
      "Margin figures are illustrative front margin (RRP less VAT-aligned cost). They exclude store overheads, promotions, shrink and the 5% Checkers contribution to foundations. Confirm pack sizes and SKUs on the term sheet.",
  ...
  giving: {
    ...
    detail:
      "Together, Checkers and Big Five Foods ring-fence 10% of partnership product turnover (Checkers 5% + Big Five Foods 5%) so every sale also supports Restore Africa Foundation and A Heart To Help — Checkers as the face of good in the community.",
    bases: {
      checkers:
        "Checkers: 5% of retail sell-through value of partnership SKUs (at RRP, incl. VAT) — customer-facing volume Checkers already owns.",
      foods:
        "Big Five Foods: 5% of trade turnover on partnership SKUs sold to Checkers (at R45 ex. VAT) — matching Checkers’ commitment.",
    },
    perUnitIllustrative: {
      atRrp: {
        basis: "Per unit sold at RRP R67 (incl. VAT)",
        checkers: RRP_INCL_VAT * 0.05,
    ...
    example: {
      units: 100_000,
      label: "Illustrative · 100,000 packs sold through Checkers",
      checkersRetailTurnover: 100_000 * RRP_INCL_VAT,
      foodsTradeTurnover: 100_000 * TRADE_EX_VAT,
      checkersContribution: 100_000 * RRP_INCL_VAT * 0.05,
      foodsContribution: 100_000 * TRADE_EX_VAT * 0.05,
      checkersMarginPool: 100_000 * CHECKERS_MARGIN_RAND,
      get combined() {
        return this.checkersContribution + this.foodsContribution;
      },
    },
  },
  ...
  pathways: [
    {
      id: "retail",
      title: "Checkers sells with purpose",
      desc: "Stock the Mandela pack at RRP R67. Shoppers leave with fortified food; Checkers earns margin and funds community good from sell-through.",
    },
    {
      id: "donate",
      title: "Checkers donates with dignity",
      desc: "Checkers CSI or franchisees purchase product for foundations and feeding schemes — real meals, with Checkers’ name on the act of care. SA Harvest moves donations to soup kitchens, feeding schemes, Restore Africa Foundation and A Heart To Help.",
    },
    {
      id: "hybrid",
      title: "Checkers campaigns that stick",
      desc: "Shelf sales + Mandela Day / hunger-season drives + store collections. One pack, sell + donate + SA Harvest last-mile: Checkers does good.",
    },
  ],
  ...
  npos: [
    ...
    },
    {
      ...
      summary:
        "SA Harvest rescues nutritious food and fights hunger at scale (saharvest.org). In this Checkers × Big Five Foods partnership, SA Harvest’s role is delivery logistics: moving donated product to soup kitchens, community feeding schemes, Restore Africa Foundation programmes and A Heart To Help feeding pathways — so Checkers donations reach plates with dignity and reliability.",
      focus: [
        "Last-mile delivery",
        "Soup kitchens",
        "Feeding schemes",
  ...
  /** Checkers-centred narrative outcomes */
  outcomes: [
    {
      t: "Checkers as a force for good",
      d: "Every Mandela pack sold or donated carries Checkers’ community leadership — not abstract CSI, but food people can eat.",
    },
    {
      t: "Shoppers feel the difference",
      d: "Affordable fortified staples on Checkers shelves; a clear Mandela-aligned story customers are proud to support.",
    },
    {
    ...
    },
    {
      ...
      d: "Healthy front margin at R67 RRP, plus a purpose line that strengthens Checkers’ local reputation and loyalty.",
    },
  ],
  ...
  roadmap: [
    {
      n: "01",
      t: "Align",
      d: "Term sheet: SKUs, pricing (R45 / R67), Checkers margin discipline, 5%+5% giving, NPO beneficiaries, Checkers brand story.",
    },
    {
      n: "02",
      t: "List",
      d: "Range listing, pilot Checkers clusters, planograms, staff brief and Mandela / “Checkers does good” creative.",
    },
    {
      n: "03",
      t: "Launch",
    ...
    },
    {
      n: "04",
      t: "Prove",
      d: "Quarterly Checkers impact pack: units, rand to NPOs, foundation stories and photos — content Checkers can share.",
    },
    {
      n: "05",
      t: "Scale",
      d: "More stores, more SKUs, Mandela Day / hunger season / back-to-school — Checkers’ good becomes a national rhythm.",
    },
  ],

  /** Product credibility for Checkers buyers — no supplier GP or internal cost advantage. */
  productCredibility: [
    {
    ...
    },
    {
      ...
      d: "Long shelf life, simple prep — works for Checkers inventory and for foundation donations.",
    },
    {
    ...
    },
    {
      ...
      d: "Group experience on national school-nutrition pathways — discipline Checkers can trust in a partner.",
    },
    {
      t: "Proud African brand story",
      d: "Mandela campaign pack gives Checkers a purpose line customers understand in one glance.",
    },
  ],
  ...
  honesty: [
    ...
    "Checkers margin figures are illustrative front margin (RRP less cost aligned at 15% VAT): ~R15.25 (~23%) on 1kg and ~R12.80 (~38%) on 400g. They are not net store profit and exclude overheads, promotions, shrink and the 5% Checkers contribution.",
    "5% + 5% giving bases (Checkers retail sell-through vs Foods trade turnover) are the recommended model; legal wording sits in the commercial agreement.",
  ...
  impactReport: {
    ...
    unitAssumptions: {
      ...
      checkersFrontMarginPerPack: CHECKERS_MARGIN_RAND,
...
export function buildCheckersImpactReport() {
  const ir = CHECKERS_PARTNERSHIP.impactReport;
  ...
  const tiers = ir.storeTiers.map((t) => {
    ...
    const checkersFrontMargin = packsYear * u.checkersFrontMarginPerPack;
    const checkersGive5 = retailTurnover * 0.05;
    const foodsGive5 = tradeTurnover * 0.05;
    const combined10 = checkersGive5 + foodsGive5;
  ...
  const national = {
    ...
    checkersFrontMargin: sum("checkersFrontMargin"),
    checkersGive5: sum("checkersGive5"),
  ...
  const pilot = {
    ...
    checkersFrontMargin: national.checkersFrontMargin * pilotFactor,
...
export type CheckersImpactReport = ReturnType<typeof buildCheckersImpactReport>;
