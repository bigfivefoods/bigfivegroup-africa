    ...
    <div className="overflow-x-clip bg-[#fafafa] min-h-[70vh] flex items-center">
      <div className="max-w-xl mx-auto px-4 sm:px-6 py-16 sm:py-24 text-center w-full">
        ...
        <p className="text-base sm:text-lg text-[#525252] leading-relaxed mb-8">
          If you used the form, your note is with the team at{" "}
          <strong className="text-black">{CONTACT_EMAIL}</strong>. We&apos;ll reply to confirm next
          steps — typically within 1–2 business days. Prefer a faster loop? Use WhatsApp or phone
          below.
        </p>

        <div className="flex flex-col gap-3 max-w-sm mx-auto mb-10">
          <a
            href={`mailto:${CONTACT_EMAIL}?subject=Big%20Five%20briefing`}
