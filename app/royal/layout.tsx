...
export const metadata: Metadata = {
  ...
  description:
    "Big Five Group has close ties to the royal family, is planning to partner with the royal family, and supports them and the work they do — serving communities with dignity, Ubuntu, and lasting impact.",
  openGraph: {
