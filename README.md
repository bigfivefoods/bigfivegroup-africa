...
**Contact:** form delivers via Resend to `craig@bigfivegroup.africa` (Reply-To =
visitor). WhatsApp / phone for a faster loop. Briefings are confirmed manually.
...
- `/royal` and `/tribal` redirect to `/group`.
